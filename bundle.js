...
/***/ function(module, exports, __webpack_require__) {
	...
	var _localStorage = __webpack_require__(196);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _time_tracker = __webpack_require__(190);
	
	var _time_tracker2 = _interopRequireDefault(_time_tracker);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'container' },
	          _react2.default.createElement(_time_tracker2.default, null)
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	* */
	...
	var TimeTracker = function (_Component) {
	  _inherits(TimeTracker, _Component);
	  ...
	  function TimeTracker(props) {
	    ...
	    _this.onTaskNameChange = function () {
	      _this.setState({
	        taskName: _this.taskName.value
	      });
	    };
	
	    _this.onTaskPriceChange = function () {
	      _this.setState({
	        taskPrice: _this.taskPrice.value
	      });
	    };
	    ...
	    _this.onFormSubmit = function (event) {
	      ...
	      if (_this.state.taskTime) {
	        var _this$state = _this.state;
	        var taskName = _this$state.taskName;
	        var taskPrice = _this$state.taskPrice;
	        var taskTime = _this$state.taskTime;
	        ...
	        _timer2.default.start(_this);
	      }
	    };
	
	    _this.renderTasks = function (task) {
	      ...
	      return _react2.default.createElement(_task2.default, _extends({}, task, {
	        renderTime: _timer2.default.getStringValue2,
	        changeTaskName: _this.props.changeTaskName,
	        key: task.taskId.toString()
	      }));
	    };
	
	    _this.renderTime = function () {
	      return _timer2.default.getStringValue1(_this.state.taskTime);
	    };
	  ...
	  _createClass(TimeTracker, [{
	    ...
	    value: function render() {
	      ...
	      var btnText = this.state.taskTime ? "Stop" : "Start";
	...
	exports.default = (0, _reactRedux.connect)(mapStateToProps, { addTask: _index.addTask, changeTaskName: _index.changeTaskName })(TimeTracker);
...
/***/ function(module, exports) {
	...
	var CHANGE_TASK_NAME = exports.CHANGE_TASK_NAME = 'CHANGE_TASK_NAME';
	var RESUME_TASK = exports.RESUME_TASK = 'RESUME_TASK';
	
	var taskId = 0;
	
	var addTask = exports.addTask = function addTask(_ref) {
	  var taskName = _ref.taskName;
	  var taskPrice = _ref.taskPrice;
	  var taskTime = _ref.taskTime;
	...
	var changeTaskName = exports.changeTaskName = function changeTaskName(taskId, taskName) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Task = function (_Component) {
	  ...
	  _createClass(Task, [{
	    ...
	    value: function render() {
	      ...
	      var taskTime = this.props.taskTime;
	      var _state = this.state;
	      var taskName = _state.taskName;
	      var taskPrice = _state.taskPrice;
	
	
	      return _react2.default.createElement(
	        'div',
	        { className: '' },
	        this.state.editingTaskName ? _react2.default.createElement('input', (_React$createElement = {
	          ref: function ref(input) {
	            return _this2.taskName = input;
	          },
	          onChange: this.onTaskNameChange,
	          ...
	          return _this2.state.editingTaskName && _this2.state.focus ? input.focus() : null;
	        }), _defineProperty(_React$createElement, 'className', ''), _defineProperty(_React$createElement, 'type', 'text'), _defineProperty(_React$createElement, 'placeholder', 'Task name'), _defineProperty(_React$createElement, 'value', this.state.taskName), _React$createElement)) : _react2.default.createElement(
	          'div',
	          { className: '',
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: '' },
	              this.props.renderTime(taskTime)
	            ),
	            _react2.default.createElement(
	              'div',
	              { className: '' },
	              this.renderGain(this.props),
	              ' rub'
	            )
	          )
	        )
	...
	var _initialiseProps = function _initialiseProps() {
	  ...
	  this.onTaskNameClick = function () {
	    // DELETE prevTaskName
	    _this3.prevTaskName = _this3.state.taskName;
	  ...
	  this.onTaskNameChange = function () {
	
	    _this3.setState({
	      taskName: _this3.taskName.value,
	      focus: false
	    });
	  };
	
	  this.onTaskNameBlur = function () {
	    ...
	    if (_this3.prevTaskName != _this3.state.taskName) {
	      _this3.props.changeTaskName(_this3.props.taskId, _this3.state.taskName);
	    }
	  };
	
	  this.onTaskNameKeyPress = function (event) {
	    ...
	    if (keyCode == 27) {
	      _this3.setState({
	        taskName: _this3.prevTaskName,
	        editingTaskName: false
	      });
	    }
	  };
	
	  this.renderGain = function (_ref) {
	    var taskPrice = _ref.taskPrice;
	    var taskTime = _ref.taskTime;
	
	    var _taskTime = _slicedToArray(taskTime, 2);
	
	    var hours = _taskTime[0];
	    var minutes = _taskTime[1];
	
	
	    var gain = parseInt(taskPrice) * hours + parseInt(taskPrice) / (60 / minutes);
...
/***/ function(module, exports) {
	...
	Timer.start = function (component) {
	
	  var tick = function tick() {
	    var _ref = component.state.taskTime || [0, 0, 0];
	...
	Timer.stop = function (component) {
	  // TODO: check on component.timer => error
	
	  clearInterval(component.timer);
	};
	
	Timer.getStringValue1 = function (taskTime) {
	  //console.log(taskTime)
	  var _ref3 = taskTime || [0, 0, 0];
	  ...
	  var withZero = function withZero(number) {
	...
	Timer.getHoursBySeconds = function (seconds) {
	  return parseInt(seconds / 3600);
	};
	
	Timer.getStringValue2 = function (taskTime) {
	  var _ref5 = taskTime || [0, 0, 0];
	...
	var getHoursBySeconds = exports.getHoursBySeconds = function getHoursBySeconds(seconds) {
	  return parseInt(seconds / 3600);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducer_tasks = __webpack_require__(195);
	
	var _reducer_tasks2 = _interopRequireDefault(_reducer_tasks);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var rootReducer = (0, _redux.combineReducers)({
	  tasks: _reducer_tasks2.default
	});
